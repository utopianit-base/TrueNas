function Get-TrueNasJob
{
    ...
    End
    {
        ...
        if ( $PsBoundParameters.ContainsKey('Id'))
        {
            ...
            $temp | Add-Member -MemberType NoteProperty -Name "LogsPath" -Value "$($result.logs_path)"
            $temp | Add-Member -MemberType NoteProperty -Name "logsExcerpt" -Value "$($result.logs_excerpt)"
            ...
            $temp | Add-Member -MemberType NoteProperty -Name "ExcInfo" -Value "$($result.exc_info)"
            ...
            switch ($Property)
            {
                ...
                'fiveLast'
                {
                    ...
                    for ($i = 0; $i -lt $result.Count; $i++)
                    {
                        ...
                        $temp | Add-Member -MemberType NoteProperty -Name "LogsPath" -Value "$($result[$i].logs_path)"
                        $temp | Add-Member -MemberType NoteProperty -Name "LogsExcerpt" -Value "$($result[$i].logs_excerpt)"
                        ...
                        $temp | Add-Member -MemberType NoteProperty -Name "ExcInfo" -Value "$($result[$i].exc_info)"
