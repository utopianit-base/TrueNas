function Get-TrueNasGlobalConfig
{
    ...
    End
    {
        ...
        $Global | add-member -name "Ipv4Gateway" -membertype NoteProperty -Value "$($result.ipv4gateway)"
        $Global | add-member -name "Ipv6Gateway" -membertype NoteProperty -Value "$($result.ipv6gateway)"
        ...
        $Global | add-member -name "NetwaitEnabled" -membertype NoteProperty -Value "$($result.netwait_enabled)"
        $Global | add-member -name "NetwaitIP" -membertype NoteProperty -Value "$($result.netwait_ip)"
